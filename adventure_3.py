...
# Endings# (evil ending narrow alley with choice, good ending bridge,
# good ending footpath)


def bad_ending(items):
    print_pause("They gain quickly on you and when you turn around to face "
                "them, you feel a nerving pain in the back ... ")
    print_pause("...and you feel more and more tired as you think"
                "to the ground getting slowly unconscience")
    print_pause("As you get dragged away by two of the hodded man, another "
